   ...
   <section>
        <div className='container grid grid-cols-1 md:grid-cols-2 min-h-[650px] relative'>
            ...
            <div className='flex flex-col justify-center py-14 md:py-0 relative z-10'>
                <div className='md:text-center text-left space-y-6 lg:max-w-[400px]:'>
                    <motion.h1
                    ...
                    animate='visible'
                     className='text-5xl lg:text-6xl font-bold leading-relaxed xl:leading-loose     font-averia'>
                        Healthy
                        <br />
                        Fresh <span className='text-secondary'>        
                        Fruits!</span>
                    </motion.h1>
                    <motion.p
                    ...
                    className='text-gray-400'>
                        ...
                        breakfast.Eat Daily for good health and mind Order now get 20%
